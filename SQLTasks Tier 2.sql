...
SELECT f.name, CONCAT(sub.firstname,' ',sub.surname) as member_name
FROM Facilities AS f 
INNER JOIN
(SELECT DISTINCT b.memid, surname, firstname, b.facid FROM Members JOIN Bookings as b ON Members.memid=b.memid) AS sub
